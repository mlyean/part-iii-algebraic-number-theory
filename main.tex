...
\end{theorem}
\begin{proof}
    We show commutativity of the right square. Let $\fp$ be a prime ideal of $K$, $\fp \nmid \fm$. Let $\pi \in K_\fp$ be a uniformiser. Then $\overline{([n_\fp(\pi)])}_\fm = \fp$ as above. We need $([n_\fp(\pi)], L/K) = \left(\frac{L/K}{\fp}\right)$. This follows from the product formula for the global norm residue symbol. % TODO: What is this?
